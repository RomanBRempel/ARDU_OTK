...
## Corpus Check
- 78 files · ~151,480 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1767 nodes · 3555 edges · 180 communities (96 shown, 84 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 248 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `28610afe`
...
## Communities (180 total, 84 thin omitted)

### Community 0 - "SerialVehicleLink"
Cohesion: 0.09
Nodes (19): SerialVehicleLink, StatusTextAssembly, Action, bool, CancellationTokenSource, IReadOnlyList, string, uint (+11 more)

### Community 1 - "SerialCompassCalibrationJob"
Cohesion: 0.06
Nodes (41): PageProgress, Action, MavParamType, MavSeverity, StatusTextEvent, CalibrationRequest, CalibrationRunResult, CalibrationStage (+33 more)
...
Cohesion: 0.22
Nodes (4): CalibrationReference, Task, EventArgs, InfoBarSeverity

### Community 4 - "CompassIdentity"
Cohesion: 0.07
Nodes (21): CompassSlot, ReferenceParamSet, CompassFieldComparison, CompassIdentity, CompassSlotComparison, CompassTopologyVerdict, ExpectedCompassSlot, ExternalKind (+13 more)
...
### Community 9 - "Page"
Cohesion: 0.07
Nodes (41): AzimuthBar, ChecksList, ChecksSummaryText, ErrorBar, GateBar, HistoryHintText, HistoryList, LayoutStates (+33 more)

### Community 10 - "ReferenceEditorPage"
Cohesion: 0.09
Nodes (20): AddScriptButton, BrowseButton, ReadScriptsButton, SaveButton, SnapshotButton, ReferenceEditorPage, bool, CalibrationTolerances (+12 more)

### Community 11 - "Page"
Cohesion: 0.05
Nodes (45): DiffList, HeadingBox, AuthorBox, AuthorPanel, CancelButton, DescriptionBox, ErrorBar, FrozenBar (+37 more)

### Community 12 - "ParameterRoleMap"
Cohesion: 0.13
Nodes (11): ParameterRole, ParameterRoleMap, ParameterRoleOverride, ParameterRoleRule, Dictionary, IEnumerable, IReadOnlyList, string (+3 more)

### Community 13 - "CompassCalibrationPage"
Cohesion: 0.10
Nodes (18): NewRunButton, CompassCalibrationPage, bool, CancellationToken, CancellationTokenSource, Exception, Func, IEnumerable (+10 more)
...
Cohesion: 0.22
Nodes (8): AcceptanceStepRow, AcceptanceStepState, ParameterDifferenceRow, bool, ParameterDifference, ParamWriteRecord, string, Visibility
...
Cohesion: 0.06
Nodes (40): AppPaths, AppServices, bool, CalibrationReference, CancellationToken, Failure, FullParameterSet, IProgress (+32 more)
...
### Community 26 - ".Log"
Cohesion: 0.31
Nodes (3): List, MavSeverity, ValueTask
...
### Community 38 - "Task"
Cohesion: 0.24
Nodes (8): CancellationToken, FullParameterSet, ParameterProgress, Task, MavParamType, MavResult, ParamValue, SerialPort
...
Cohesion: 0.19
Nodes (9): NewCalibrationReference, ReferenceParameters, CompassSnapshot, FullParameterSet, IReadOnlyList, ParameterRoleMap, ReferenceScript, ExpectedCompassSlot (+1 more)

### Community 48 - "TelemetrySession"
Cohesion: 0.14
Nodes (10): MagAccumulator, TelemetrySession, Dictionary, double, MagSample, object, ImuMessage, SensorHealth (+2 more)
...
Cohesion: 0.16
Nodes (10): ExpectedCompassSlotRow, ParameterRoleRow, ParameterRoleSectionRow, ReferenceCaption, ReferenceScriptRow, ObservableCollection, ReferenceScript, ParameterControl (+2 more)
...
Cohesion: 0.22
Nodes (3): MotorCompToggle, TextChangedEventArgs, ToggleSwitch
...
Cohesion: 0.20
Nodes (7): CompassIdentityRow, CompassRow, WatchedParameterRow, VehicleLiveState, Visibility, double, MagSample

### Community 129 - "Func"
Cohesion: 0.38
Nodes (4): IVehicleLink, CancellationToken, Task, TimeSpan

### Community 144 - "CalibrationRequest"
Cohesion: 0.28
Nodes (5): IProgress, MavFtpEntry, ReadOnlyMemory, MavFtpOpcode, MavFtpPayload

### Community 145 - "CalibrationRunResult"
Cohesion: 0.27
...
Cohesion: 0.12
Nodes (12): MainPage, bool, ParameterProgress, string, WorkstationSettings, Brush, CalibrationLogRow, CancellationTokenSource (+4 more)
