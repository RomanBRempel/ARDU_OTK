...
## Corpus Check
- 92 files · ~181,585 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1976 nodes · 4482 edges · 124 communities (105 shown, 19 thin omitted)
- Extraction: 92% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 328 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e749d1bb`
...
Cohesion: 0.06
Nodes (38): AcceptanceSession, ArmReadiness, StepResult, bool, CancellationToken, Failure, IProgress, IReadOnlyDictionary (+30 more)
...
Cohesion: 0.18
Nodes (5): NavigationEventArgs, Task, CalibrationTolerances, TimeSpan, CalibrationReference
...
Cohesion: 0.12
Nodes (11): ReferenceEditorPage, bool, Exception, int, List, NumberBox, NumberBoxValueChangedEventArgs, ObservableCollection (+3 more)
...
Cohesion: 0.11
Nodes (12): ParameterRole, ParameterRoleMap, ParameterRoleOverride, ParameterRoleRule, Dictionary, IEnumerable, int, IReadOnlyList (+4 more)
...
Cohesion: 0.18
Nodes (3): IReadOnlyList, List, RoutedEventArgs
...
Cohesion: 0.16
Nodes (15): DEV_ID Validity Rule (read-back equality is not proof), Compass::force_save_calibration() path (UNVERIFIED), Rollback Snapshot (pre-write .param capture), Transfer State Machine (states 0-14), Reboot survival and COM re-enumeration, Thirteen safety rules for a tool that writes to flight hardware, Ordered board-came-back detection (heartbeat gap, banner, time_boot_ms), MAV_CMD_PREFLIGHT_REBOOT_SHUTDOWN (246), param1=1 (+7 more)
...
Cohesion: 0.10
Nodes (21): COMPASS_TYPEMASK to COMPASS_DISBLMSK rename: probe both names, IsBenchBusy predicate (fail-safe to busy), SITL testing scope and its limits, UpdateService.IsBusy update interlock, No message received is Inconclusive, never Verified, ARMING_CHECK vs ARMING_SKIPCHK inverted polarity: probe by name, A clean run can be an artefact of disabled check bits, PREARM_CHECK bit (0x10000000) (+13 more)
...
Cohesion: 0.12
Nodes (22): Azimuth input must be TRUE north, not magnetic, MAV_CMD_FIXED_MAG_CAL_YAW (42006), Soft-iron destruction conflict (fixed-yaw forces DIA=1,1,1 / ODI=0,0,0), Workflow (a): Compass Calibration Transfer, Workflow (b): Fixed-Yaw / Large-Vehicle Calibration, Procedure: make external compass primary and set use flags (Phases A-F), Never leave the board with zero COMPASS_USE* set, AHRS2 must never be a silent fallback for ATTITUDE (+14 more)
...
Cohesion: 0.12
Nodes (19): MAG_CAL_REPORT.fitness judged against COMPASS_CAL_FIT (x2 rule), Instance Mapping by decoded device id, Boot-time per-instance block swap (_reorder_compass_params), BusType enum (0-7, no EXTERNALAHRS), Classify (external/internal decision procedure), CompassDevId (DEV_ID bitfield decode), CompassRow (compass panel per-instance view model), Compass devtype table (AP_Compass_Backend.h authoritative) (+11 more)
...
Cohesion: 0.20
Nodes (10): Handoff to verification (exact conditions), MAG_CAL_STATUS enum (with ArduPilot extensions 6-10), Onboard mag cal commands (DO_START/ACCEPT/CANCEL_MAG_CAL), _reset_compass_id() side effect on priority slots, COMPASS_PRIOx_ID Priority Model, STATUSTEXT chunk reassembly (id + chunk_seq) before string matching, STATUSTEXT Ingestion and MAV_SEVERITY inversion, MAV_CMD_RUN_PREARM_CHECKS (401) and its collection window (+2 more)
...
Cohesion: 0.18
Nodes (7): PageProgress, Action, MavSeverity, CalibrationRequest, CalibrationStage, CheckOutcome, ICalibrationProgress
...
Cohesion: 0.09
Nodes (21): AirData, AttitudeSample, GpsFix, MavCommand, MavResult, ParamValue, PrearmReport, SensorHealth (+13 more)
...
Cohesion: 0.50
Nodes (3): RunRow, Brush, string

### Community 64 - "Establishing the Creative Foundation"
Cohesion: 0.12
Nodes (11): OsdReferenceChoice, ReferenceEditorArgs, ReferenceRow, Visibility, BoardParameterSnapshot, ScriptComparison, ARDU_OTK, ARDU_OTK.Services.Fc (+3 more)

### Community 65 - ".OnPortSelectionChanged"
Cohesion: 0.22
Nodes (9): IVehicleFileTransfer, IVehicleLink, CancellationToken, IProgress, IReadOnlyList, ReadOnlyMemory, Task, TimeSpan (+1 more)
...
Cohesion: 0.13
Nodes (16): MagSample, TelemetrySnapshot, AcceptanceChecks, CheckIds, CompassComplaint, CompassComplaintKind, ComplaintRule, double (+8 more)
...
Cohesion: 0.11
Nodes (12): MainPage, bool, Brush, CancellationTokenSource, DateTimeOffset, Dictionary, IEnumerable, long (+4 more)

### Community 147 - "CompassSnapshot"
Cohesion: 0.06
Nodes (37): AppServices, bool, CancellationToken, Failure, IProgress, IReadOnlyList, List, Path (+29 more)
...
Cohesion: 0.07
Nodes (21): Application, App, Exception, AppTitleBar, OsdItem, ReferencesItem, RootFrame, RootNav (+13 more)
...
## Knowledge Gaps
- **106 isolated node(s):** `net10.0-windows10.0.26100.0`, `Microsoft.Windows.SDK.BuildTools (10.0.28000.2526)`, `Microsoft.WindowsAppSDK (2.3.1)`, `Velopack (1.2.0)`, `Microsoft.Data.Sqlite (10.0.10)` (+101 more)
