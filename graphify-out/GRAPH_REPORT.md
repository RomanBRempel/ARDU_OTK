...
## Corpus Check
- 3 files · ~192,044 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2180 nodes · 4455 edges · 221 communities (106 shown, 115 thin omitted)
...
## Communities (221 total, 115 thin omitted)

### Community 0 - "AcceptanceSession"
Cohesion: 0.07
Nodes (40): AcceptanceSession, ArmReadiness, StepResult, bool, CancellationToken, FullParameterSet, IReadOnlyList, List (+32 more)

### Community 1 - "AppServices"
Cohesion: 0.06
Nodes (36): AppServices, AppPaths, bool, CalibrationRequest, CalibrationRunResult, CancellationToken, CompassSnapshot, Failure (+28 more)

### Community 2 - "CompassIdentity"
Cohesion: 0.06
Nodes (29): CompassFieldComparison, CompassIdentity, CompassSlotComparison, CompassTopologyVerdict, ExpectedCompassSlot, ExternalKind, MagAxis, CompassSlot (+21 more)

### Community 3 - "SqliteCalibrationStore"
Cohesion: 0.09
...
### Community 5 - "ParameterDifferenceRow"
Cohesion: 0.07
Nodes (24): AcceptanceStepRow, AcceptanceStepState, ChannelField, ParameterDifferenceRow, ScriptDifferenceRow, bool, Func, IEnumerable (+16 more)

### Community 6 - "ParameterRoleMap"
Cohesion: 0.08
...
### Community 7 - "SerialCompassCalibrationJob"
Cohesion: 0.15
...
### Community 10 - "MavlinkProtocol.cs"
Cohesion: 0.11
...
### Community 11 - "CalibrationContracts.cs"
Cohesion: 0.08
Nodes (26): ParamMismatchRow, bool, string, CalibrationRequest, CalibrationRunResult, CalibrationStage, CalibrationTolerances, CompassDeviceId (+18 more)
...
### Community 15 - "Abstractions.cs"
Cohesion: 0.11
Nodes (21): AirData, AttitudeSample, GpsFix, IVehicleFileTransfer, IVehicleLink, MavCommand, MavResult, MavSeverity (+13 more)

### Community 16 - "Establishing the Creative Foundation"
Cohesion: 0.07
...
### Community 17 - "Task"
Cohesion: 0.17
Nodes (11): CancellationToken, Dictionary, FullParameterSet, HashSet, ParameterProgress, ParamValue, PrearmReport, Task (+3 more)
...
### Community 22 - ".OnRoleSliderChanged()"
Cohesion: 0.09
...
### Community 23 - "SettingsPage"
Cohesion: 0.13
Nodes (12): UpdateActionButton, SettingsPage, bool, double, EventArgs, InfoBarSeverity, NumberBox, NumberBoxValueChangedEventArgs (+4 more)

### Community 24 - "graph_freshness.py"
Cohesion: 0.17
Nodes (25): compare(), corpus_on_disk(), describe(), emit_hook(), force_utf8_streams(), git(), health_report(), is_corpus_path() (+17 more)

### Community 25 - "ReferenceParamFile"
Cohesion: 0.16
Nodes (8): ReferenceParamSet, ReferenceParamFile, char, int, IReadOnlyDictionary, IReadOnlyList, string, float

### Community 26 - ".RunAcceptanceAsync()"
Cohesion: 0.19
Nodes (5): CancellationToken, Task, CalibrationReference, CheckOutcome, MavSeverity

### Community 27 - ".FtpRequestAsync()"
Cohesion: 0.17
Nodes (10): MavFtpDirectory, MavFtpEntry, MavFtpError, MavFtpOpcode, MavFtpPayload, int, ReadOnlySpan, IProgress (+2 more)

### Community 28 - "Page"
Cohesion: 0.13
Nodes (21): BoardStateText, EmptyText, GeneralList, GeneralPanel, MockNoteText, MockSizeText, Page, PageBar (+13 more)

### Community 29 - "OsdPage"
Cohesion: 0.15
Nodes (11): OsdPage, bool, double, EventArgs, InfoBarSeverity, int, IReadOnlyDictionary, ObservableCollection (+3 more)

### Community 30 - ".RebuildRoleTree()"
Cohesion: 0.12
...
### Community 37 - "ARDU_OTK.Services.Fc"
Cohesion: 0.13
Nodes (9): OsdReferenceChoice, BoardParameterSnapshot, VehicleLinkException, ScriptComparison, CalibrationStoreException, ARDU_OTK.Services.Fc, ARDU_OTK.Services.Store, ARDU_OTK.Services.Fc.Mavlink (+1 more)

### Community 38 - "Page"
Cohesion: 0.18
Nodes (17): AzimuthBar, ChecksSummaryText, ErrorBar, GateBar, HistoryHintText, Page, RewriteBar, RewriteProgressText (+9 more)

### Community 39 - "CompassCalibrationPage"
Cohesion: 0.15
...
### Community 40 - "WinUI App Structure"
Cohesion: 0.15
...
### Community 42 - ".BuildChip()"
Cohesion: 0.15
Nodes (8): Border, Column, Row, OsdScreen, OsdScreenSize, IReadOnlyList, SelectorBar, SelectorBarSelectionChangedEventArgs

### Community 43 - "TelemetrySession"
Cohesion: 0.18
...
### Community 46 - "Implementation Ecosystem (framework-tailored libraries)"
Cohesion: 0.16
...
### Community 47 - "WinUI Reference Sections Index"
Cohesion: 0.21
...
### Community 48 - "Accessibility, Input, and Localization"
Cohesion: 0.18
...
### Community 49 - "ARDU_OTK"
Cohesion: 0.13
Nodes (7): MainWindow, Program, ReferenceEditorArgs, ARDU_OTK, NavigationView, NavigationViewSelectionChangedEventArgs, STAThread

### Community 50 - ".Subscribe()"
Cohesion: 0.18
Nodes (8): FrameSubscription, Exception, Func, GpsFix, Channel, FrameSubscription, IDisposable, VehicleLinkException

### Community 51 - ".Imu()"
Cohesion: 0.29
Nodes (5): CalibrationStatus, CalibrationVerdict, double, IReadOnlyDictionary, string

### Community 52 - "VerificationVerdict record"
Cohesion: 0.15
...
### Community 53 - "Deployment: unpackaged, self-contained, Velopack"
Cohesion: 0.15
...
### Community 54 - "UpdateService.IsBusy update interlock"
Cohesion: 0.15
...
### Community 57 - "CommunityToolkit Controls and Helpers"
Cohesion: 0.18
...
### Community 58 - "Startup Failure Debugging Path"
Cohesion: 0.21
...
### Community 64 - "DEV_ID Validity Rule (read-back equality is not proof)"
Cohesion: 0.18
...
### Community 65 - "Classify (external/internal decision procedure)"
Cohesion: 0.22
...
### Community 66 - "Transfer State Machine (states 0-14)"
Cohesion: 0.24
...
### Community 67 - "Telemetry Data Model (attitude, voltage, current, mode, sentinels)"
Cohesion: 0.20
...
### Community 69 - "Navy + Green Brand Palette (shared app color identity)"
Cohesion: 0.36
...
### Community 74 - "Procedure: make external compass primary and set use flags (Phases A-F)"
Cohesion: 0.25
...
### Community 78 - "ARDU OTK Square 44x44 App Tile Icon (scale-200)"
Cohesion: 0.50
...
### Community 81 - "Connect Handshake (HEARTBEAT, autopilot==3 gate, AUTOPILOT_VERSION)"
Cohesion: 0.29
...
### Community 82 - "LockScreenLogo.scale-200 (app lock screen logo asset)"
Cohesion: 0.52
...
### Community 83 - "Square44x44Logo targetsize-24 altform-unplated (app icon asset)"
Cohesion: 0.52
...
### Community 84 - "Green circular checkmark badge overlay (bottom-right corner)"
Cohesion: 0.52
...
### Community 86 - ".TryDetectAsync()"
Cohesion: 0.33
Nodes (5): WorkstationFix, WorkstationLocator, CancellationToken, Task, TimeSpan

### Community 87 - "Square44x44Logo targetsize-48 altform-lightunplated (app tile icon 48px)"
Cohesion: 0.60
...
### Community 88 - "ARDU OTK Wide Tile Logo (310x150 @200%)"
Cohesion: 0.53
...
### Community 89 - ".OnFormFieldChanged()"
Cohesion: 0.53
Nodes (5): AzimuthBox, OperatorBox, ReferenceFileBox, UnitIdBox, TextBox

### Community 90 - "ListView"
Cohesion: 0.33
Nodes (6): ChecksList, HistoryList, LogList, MismatchList, StagesList, ListView

### Community 91 - ".OnMockSizeChanged()"
Cohesion: 0.33
Nodes (4): MockHost, ScreenPanel, SizeChangedEventArgs, Grid

### Community 92 - ".OnRoleGroupCollapsed()"
Cohesion: 0.47
